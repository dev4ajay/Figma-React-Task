...
function PanAadhaarDetails() {
  ...
  const handleFileUpload = (e) => {
    ...
    console.log("Uploaded Aadhar Card:", fileName);
  ...
  const PanCardUpload = (e) => {
    ...
    console.log("Uploaded Pan Card:", fileName);
  ...
  const BusinessSubmit = async (e) => {
    ...
    try {
      ...
      if (res.status === 201) {
        Swal.fire({
          icon: "success",
          text: "! PAN/Aadhaar Details Successfully !",
          timer: 3000,
    ...
    <>
      <section>
        <div className="container mt-4 mb-3">
          <div className="side-content-head">  PAN/Aadhaar Details</div>
      ...
      <label className="group-label">
        Aadhaar  * <img src={iicon} alt="icon" />
      </label>
      <div className="flex items-center justify-center ">
        ...
        >
          ...
          />
            ...
            <div className="col-lg-6 mt-2 mb-2">
      <label className="group-label">
        Pan Card * <img src={iicon} alt="icon" />
      </label>
      <div className="flex items-center justify-center ">
        <label
          id="uploadfile"
...
export default PanAadhaarDetails;
